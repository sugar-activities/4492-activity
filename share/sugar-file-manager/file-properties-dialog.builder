          ...
          <object class="GtkTable" id="table1">
            ...
            <child>
              <object class="GtkLabel" id="location_label">
                <property name="visible">True</property>
                <property name="can_focus">False</property>
                <property name="label" translatable="yes">Ubicación: </property>
              </object>
              <packing>
            ...
            <child>
              <object class="GtkLabel" id="accessed_label">
                <property name="visible">True</property>
                <property name="can_focus">False</property>
                <property name="label" translatable="yes">Accedido: </property>
              </object>
              <packing>
            ...
            <child>
              <object class="GtkLabel" id="modified_label">
                <property name="visible">True</property>
                <property name="can_focus">False</property>
                <property name="label" translatable="yes">Modificado: </property>
              </object>
              <packing>
          ...
          <object class="GtkFrame" id="permissions-frame">
                  ...
                  <object class="GtkTreeView" id="Permissions">
                    ...
                    <child>
                      <object class="GtkTreeViewColumn" id="Read">
                        <property name="sizing">autosize</property>
                        <property name="title">Lectura</property>
                        <child>
                    ...
                    <child>
                      <object class="GtkTreeViewColumn" id="Write">
                        <property name="sizing">autosize</property>
                        <property name="title">Escritura</property>
                        <child>
                    ...
                    <child>
                      <object class="GtkTreeViewColumn" id="Exec">
                        <property name="sizing">autosize</property>
                        <property name="title">Ejecución</property>
                        <child>
            ...
            <child type="label">
              <object class="GtkLabel" id="label1">
                <property name="visible">True</property>
                <property name="can_focus">False</property>
                <property name="label" translatable="yes">&lt;b&gt;Permisos&lt;/b&gt;</property>
